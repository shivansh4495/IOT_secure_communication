import ClientCrypto.AESencryption;
                        ...
                        switch (mode){
                            case "Mac":
                                ...
                                try {
                                    ...
                                    if (network == null) {
                                        System.out.println("Warning: Network interface not found for IP " + ip.getHostAddress());
                                        throw new Exception("Network interface is null");
                                    }
                                    
                                    byte[] mac = network.getHardwareAddress();
                                    if (mac == null) {
                                        System.out.println("Warning: Hardware address (MAC) not available");
                                    ...
                                    macAdr = sb.toString();
                                    System.out.println("Retrieved MAC address: " + macAdr);
                                } catch (Exception e) {
                                    // Fallback to a default MAC address if retrieval fails
                                    System.out.println("Error retrieving MAC address: " + e.getMessage());
                                    System.out.println("Using fallback MAC address instead");
                                    macAdr = "00-00-00-00-00-00"; // Fallback MAC address
                                }
                                
                                // debug
                                System.out.println("MAC address being used: " + macAdr);
